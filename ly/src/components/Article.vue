	...
	<div>
		<div class="nav">
			<ul>
		    	...
		    	<li class="l-title">热点详情</li>
		    </ul>
		</div>
		<div class="content">
			<div class="header clear"><h2><img :src="articleData.author_face" alt=""/></h2><p>哈哈</p></div>
		    <div class="cont">
...
<style scoped>
	...
	.nav ul{ position: relative; width:6.4rem;height:0.45rem; padding-top:0.15rem; margin:0 auto;}
	.nav ul li.l-btn{width:0.29rem;height:0.31rem; background:url(../assets/img/history.png) no-repeat 0 0; background-size:100%; margin:0 0 0 0.38rem;}
	.nav ul li.l-title{
		position: absolute;
		top: 50%;
		left: 50%;
