...
<style scoped>
	...
	.content .login-btn{width:4.65rem;height:0.65rem; background:#0094d3; color:#fff; text-align:center; line-height:0.65rem; border-radius:8px; display:block; margin-top:0.62rem; font-size:0.28rem;}
